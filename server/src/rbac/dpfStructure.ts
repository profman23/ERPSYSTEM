...
export const DPF_STRUCTURE: DPFModuleDefinition[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    screens: [
      ...
      {
        screenCode: 'TRIAL_BALANCE',
        screenName: 'Trial Balance',
        screenNameAr: 'ميزان المراجعة',
        route: '/app/finance/trial-balance',
        description: 'Trial balance report — period-based account balance summary',
        descriptionAr: 'تقرير ميزان المراجعة — ملخص أرصدة الحسابات حسب الفترة',
        sortOrder: '003',
      },
      {
        screenCode: 'ACCOUNT_LEDGER',
        screenName: 'Account Ledger',
        screenNameAr: 'دفتر الأستاذ',
        route: '/app/finance/account-ledger',
        description: 'Account ledger report — detailed transaction history per account',
        descriptionAr: 'تقرير دفتر الأستاذ — تفاصيل حركات كل حساب',
        sortOrder: '004',
      },
    ],
  },
