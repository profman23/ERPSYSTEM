  ...
  return (
    <div className={`min-h-screen bg-[#F8FAFC] flex ${isRTL ? 'flex-row-reverse' : 'flex-row'}`}>
      <aside
        ...
        `}
      >
        <div className={`h-16 flex items-center px-5 border-b border-gray-100 ${isRTL ? 'flex-row-reverse' : ''}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-gray-100 flex items-center px-6 shadow-sm">
          ...
          <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center text-white text-sm font-bold">
